...
public interface IssueDtlRepository extends JpaRepository<InspectionMedia, String> {
	 ...
	 List<InspectionMedia> getIssueDate(@Param("inspectorId") String inspectorId,@Param("assetId") String assetId);
	 ...
	 List<InspectionMedia> findIssue(@Param("inspectorId") String inspectorId,@Param("assetId") String assetId,@Param("inspectionId") String inspectionId);
	...
	// List<InspectionMedia> findByInspectorId(@Param("inspectorId") String inspectorId,@Param("issueDate") Date issueDate);
	 ...
	 List<InspectionMedia> findIssueMarker(@Param("inspectorId") String inspectorId);
	 
	 @Transactional
	 @Modifying
	 @Query("UPDATE InspectionMedia set statusType=:statusType where blobId=:blobId")
	 void updateIssue(@Param("blobId") String blobId,@Param("statusType") String statusType);
